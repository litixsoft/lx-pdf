...
//        var currentLineHeight = document.currentLineHeight(true);
        ...
        for (var idxRow = 0; idxRow < tableContentData.length; idxRow++) {
            ...
            lxHelpers.forEach(tableContentData[idxRow], function(cellData) {
                ...
                // Render cell
                var currentCellHeight = document.text(cellData.text, currentCellPositionLeft, currentCellPositionTop, cellData.format).y - currentCellPositionTop;
    ...
    function convertData(source) {
        ...
        if (lxHelpers.isArray(source)) {
            ...
            for (var index = 0; index < source.length; index++) {
                target[index] = convertData(source[index]);
            }
        ...
        if (lxHelpers.isObject(source)) {
            if (source.hasOwnProperty('text')) {
                return convertData(source.text);
            } else {
                return source;
            }
        }
